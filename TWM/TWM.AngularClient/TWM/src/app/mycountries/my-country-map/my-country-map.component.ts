...
export class MyCountryMapComponent implements OnInit {
  ...
  constructor(private myCountryService: MyCountryService, private openIdConnectService: OpenIdConnectService, private route: ActivatedRoute) { }
    ...
    ngOnInit() {
      ...
      this.userLogged = this.openIdConnectService.user.id_token;
      this.isLogged = this.openIdConnectService.userAvailable;
    }
