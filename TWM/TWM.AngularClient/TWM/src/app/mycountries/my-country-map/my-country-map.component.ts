...
export class MyCountryMapComponent implements OnInit {
  ...
  constructor(private myCountryService: MyCountryService, private _authService: AuthService, private route: ActivatedRoute) { }
  ...
  ngOnInit() {
    ...
    this.userLogged = this._authService.isLoggedIn();
  }
